const cards = require("../ascension/cards");
...
function createStartingDeck() {
	...
	// }
	deck.push(new cards.BeaconOfTheLost());
	deck.push(new cards.BeaconOfTheLost());
	deck.push(new cards.AncientStag());
	deck.push(new cards.AncientStag());
	deck.push(new cards.QadimStalker());
	deck.push(new cards.QadimStalker());
	deck.push(new cards.Randall_UmbralSage());
	deck.push(new cards.Randall_UmbralSage());
	deck.push(new cards.Pathfinder$sTotem());
	deck.push(new cards.Pathfinder$sTotem());
	return deck;
}

// TODO: remove all but monsters and void to show echo ability
